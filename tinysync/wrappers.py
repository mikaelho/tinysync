...
# Add tracking wrappers to all mutating 
# functions.
# Changes use the re-entrant lock of the
# whole data structure, to avoid conflicts
# with context-protected, multi-statement
# blocks like synchronization.
